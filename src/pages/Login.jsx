        ...
        <div className='login__hero'>
            ...
            <div className='radio-body radio-body--log'>
              <form className='login-form' onSubmit={handleLogin}>
                <div className='div'>
                  ...
                  <div className='login-form__group'>
                    <input type='checkbox' id='staylogedin' />
                    <label
          ...
          {serverResp.message && (
            <div className='server-msg'>
              ...
              {serverResp.error ? (
                <AiFillCloseCircle
                  style={{ color: 'red', marginRight: '0.5rem', fontSize: '2rem' }}
                />
              ) : (
                <AiFillCheckCircle style={{ color: 'green', marginRight: '0.5rem' }} />
              )}
